...
exports.SdApi = void 0;
const axios_1 = __importDefault(require("axios"));
const string_similarity_1 = __importDefault(require("string-similarity"));
const SdResult_1 = __importDefault(require("./SdResult"));
...
class SdApi {
    ...
    txt2img(options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return new SdResult_1.default(response);
        });
    }
    /**
    ...
    img2img(options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.api.post("/sdapi/v1/img2img", {
                ...
                mask_image: (_d = options.mask_image) !== null && _d !== void 0 ? _d : null,
                ...
                override_settings_restore_afterwards: (_11 = options.override_settings_restore_afterwards) !== null && _11 !== void 0 ? _11 : true,
                script_args: (_12 = options.script_args) !== null && _12 !== void 0 ? _12 : [],
                sampler_index: (_13 = options.sampler_index) !== null && _13 !== void 0 ? _13 : undefined,
                include_init_images: (_14 = options.include_init_images) !== null && _14 !== void 0 ? _14 : false,
                script_name: (_15 = options.script_name) !== null && _15 !== void 0 ? _15 : null,
                send_images: (_16 = options.send_images) !== null && _16 !== void 0 ? _16 : true,
                save_images: (_17 = options.save_images) !== null && _17 !== void 0 ? _17 : false,
                alwayson_scripts: (_18 = options.alwayson_scripts) !== null && _18 !== void 0 ? _18 : {},
                controlnet_units: (_20 = (_19 = options.controlnet_units) === null || _19 === void 0 ? void 0 : _19.map((unit) => unit.toJson())) !== null && _20 !== void 0 ? _20 : [],
                use_deprecated_controlnet: (_21 = options.use_deprecated_controlnet) !== null && _21 !== void 0 ? _21 : false,
            });
            return new SdResult_1.default(response);
        });
    }
